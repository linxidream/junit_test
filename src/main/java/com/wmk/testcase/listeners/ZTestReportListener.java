package com.wmk.testcase.listeners;

import com.google.gson.Gson;
import com.google.gson.GsonBuilder;
import com.wmk.testcase.entity.ReportInfo;
...
public class ZTestReportListener implements TestExecutionListener {
     ...
     */
    public void outputResult(String reporterDir,String fileName) {
        try {
...
//            String destPath = reporterDir + File.separator + "report.html";
            String destPath = reporterDir + File.separator + fileName;
